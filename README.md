...
31명의 동물 직원과 사람 대표가 일하는 2D 파스텔 픽셀 오피스입니다. 첫 방문에는 전원이 출입구에서 각자 자리까지 도착한 뒤 아침 업무를 시작합니다. 같은 날 새로고침하면 현재 단계와 회의록을 복원하며 출근부터 다시 시작하지 않습니다. 대표는 조사·검수 순서가 끝난 뒤 TOP 3가 공개됐을 때만 결정합니다.
...
- 승인 단계의 후보 담당 동물 머리 위에 TOP 번호와 강한 `!` 표시
- 담당 동물을 눌러 안건을 확인하고 바로 승인하거나 승인 콘솔로 이동
- GPT로 제작한 11종 동물·사람 대표 고해상도 픽셀 아이콘 아틀라스
- 브리프 멍실장의 결재 브리핑과 노트 멍대리의 상세 회의록
