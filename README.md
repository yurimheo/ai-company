...
31명의 동물 직원과 사람 대표가 일하는 2D 파스텔 픽셀 오피스입니다. 페이지를 열면 전원이 출입구에서 각자 자리까지 도착한 뒤에만 아침 업무를 시작합니다. 대표는 조사·검수 순서가 끝난 뒤 TOP 3가 공개됐을 때만 결정합니다.
...
- GPT로 제작한 11종 동물·사람 대표 픽셀 아이콘 아틀라스
